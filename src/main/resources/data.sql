...
VALUES
    (1, 'batman','password', 'Bruce Wayne'),
    (2, 'superman','password', 'Clark Kent'),
    (3, 'catwoman', 'password','Selina Kyle'),
    (4, 'daredevil', 'password','Matt Murdock'),
    (5, 'alfred', 'password','Alfred Pennyworth'),
    (6, 'dococ', 'password','Otto Octavius'),
    (7, 'zod', 'password','Dru-Zod'),
    (8, 'spiderman', 'password','Peter Parker'),
    (9, 'ironman', 'password','Tony Stark'),
    (10, 'profx', 'password','Charles Xavier');

INSERT INTO user_roles(username, role) VALUES
    ('batman','ROLE_USER'),('superman','ROLE_ADMIN'),('catwoman','ROLE_USER'),('daredevil','ROLE_ADMIN'),('alfred','ROLE_USER'),('dococ','ROLE_USER'),
    ('zod','USER'),('spiderman','ROLE_USER'),('ironman','ROLE_USER'),('profx','ROLE_USER');
-- Messages
